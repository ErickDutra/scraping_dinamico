...
url = 'https://www.kabum.com.br/busca/placa-mae'
...
for i in range(1, ultima_pagina+1):
    url_pag = f'https://www.kabum.com.br/busca/placa-mae?page_number={i}&page_size=20&facet_filters=&sort=most_searched'
